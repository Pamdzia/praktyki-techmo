...
if len(sys.argv) > 1:
    ...
    experiment_name = 'random_forest_RAVDESS'  # Domyślna nazwa eksperymentu

results_folder = '../experiments_results'  # Ścieżka do folderu wynikowego

# Ładowanie skalera i kodera etykiet
...
csv_path = os.path.join(results_folder, 'combined_test_results.csv')
