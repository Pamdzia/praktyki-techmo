...
default_experiment_name = 'MLP_from_git_updated_connected'
...
# Budowanie modelu MLP z regularizacją i dropoutem
...
history = model.fit(X_train, y_train, batch_size=256, epochs=1000, verbose=1, validation_data=(X_dev, y_dev), callbacks=[early_stopping])
...
# Zapis modelu w nowym formacie Keras
model.save(os.path.join(experiment_name, 'mlp_model.keras'))
