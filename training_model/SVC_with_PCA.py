...
default_experiment_name = 'SVC_with_PCA_connected'
...
train_data_paths = [
    ...
    r'..\four-emotions-csv-sets\train_four_emotions_nEMO_features.csv'
]
test_data_paths = [
...
# funkcje do załadowania i łączenia datasetów train i test
...
# zdefiniowanie SVC i parametrów grid search
svc = SVC()
param_grid = {
...
# wyświetlenie i zapisanie najlepszych parametrów
...
# zapisanie do scores.txt wyników
