...
default_experiment_name = 'knn_iemocap_connected'
...
# Paths to data files
train_data_paths = [
    r'../four-emotions-csv-sets/train_iemocap_impro_features.csv',
    r'../four-emotions-csv-sets/train_iemocap_script_features.csv'
]
test_data_paths = [
    r'../four-emotions-csv-sets/train_iemocap_impro_features.csv',
    r'../four-emotions-csv-sets/train_iemocap_script_features.csv'
