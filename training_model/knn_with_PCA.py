...
default_experiment_name = 'knn_with_PCA_nEMO'
...
# przygotowanie cech do treningu
columns_to_convert = ['mfcc_mean', 'mfcc_var', 'mfcc_max', 'mfcc_min', 'mfcc_range']
...
# zastosowanie PCA i wybranie najelpszej liczby komponentow 
print("Applying PCA and selecting the best number of components...")
pca = PCA()
X_train_pca = pca.fit_transform(X_train)
explained_variance = np.cumsum(pca.explained_variance_ratio_)

# wybranie liczby komponentow ktore wyjasniaja minimum 95% zmiennych 
...
# definiowanie modelu kNN i parametrow dla grid search 
...
joblib.dump(pca, os.path.join(experiment_name, 'pca.pkl'))
