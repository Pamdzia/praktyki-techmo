...
# Budowanie modelu MLP z regularizacją, dropoutem i batch normalization
...
history = model.fit(X_train, y_train, batch_size=128, epochs=1000, verbose=1, validation_data=(X_dev, y_dev), callbacks=[early_stopping])
